...
const Page = async () => {
  const t = await getTranslations("Pages.OrderConfirmation");
  return (
    <div className="nc-OrderConfirmationPage">
      <div className="container relative pt-5 pb-16 lg:pb-20 lg:pt-5">
        {/* HEADER */}
        <header className="text-center max-w-2xl mx-auto space-y-4">
          {/* Replaced NcImage with direct SVG embed */}
          ...
          <h2 className="text-2xl font-semibold text-menu-text-light dark:text-neutral-100">
            {t("thanks")}
          </h2>
          <p className="text-sm text-menu-text-light sm:text-base dark:text-neutral-300">
            {t("orderPlaced")}
          </p>
          <div className="pt-6 space-x-4">
            <ButtonPrimary href="/">{t("continue")}</ButtonPrimary>
          </div>
        </header>
      </div>
    </div>
